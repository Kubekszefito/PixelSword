                        ...
                        if (isset($_POST["submit-buy"])) {
                            ...
                            if (mysqli_num_rows($result1) > 0) {
                                ...
                                if ($_SESSION["coin"] >= $itemPrice) {
                                    ...
                                    $sql5 = "SELECT `extras` FROM `items` WHERE `id`=$itemid";
                                    $result3 = mysqli_query($connect, $sql5);
                                    $fetch = mysqli_fetch_assoc($result3);

                                    switch($fetch["extras"]){
                                        case "+11 Inteligencja":
                                            $sql5 = "UPDATE `users` SET inteligencja=inteligencja+11 WHERE id=".$_SESSION["id"]."";
                                            mysqli_query($connect, $sql5);
                                            break;
                                        case "+40 Szczęścia":
                                            $sql6 = "UPDATE `users` SET szczescie=szczescie+40 WHERE id=".$_SESSION["id"]."";
                                            mysqli_query($connect, $sql6);
                                            break;
                                        case "+15 Wytrzymałość":
                                            $sql7 = "UPDATE `users` SET wytrzymalosc=wytrzymalosc+15 WHERE id=".$_SESSION["id"]."";
                        ...
                        if(isset($_GET["link"])){
                            switch($_GET["link"]){
                                ...
                                case "zbrojownia":
                                    ...
                                    break;
                                case "wyprawa":
                                    echo "<script>window.location.href = 'wyprawa.php';</script>";
                                    break;
                            }
                        }
